...
then
    ...
    python2.7 pydmap_read_mca.py &
    python2.7 basic_gui.py hosts=localhost ports=6041 maxbeam=16 nrangs=75 names="Mcmurdo A" beams=8 channels=a rad=mcm filepath="mcma/"
